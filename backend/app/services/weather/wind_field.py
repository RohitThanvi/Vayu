...
MAX_LOCATIONS_PER_CALL = 1000  # Open-Meteo's documented per-request limit
...
LO1, LO2 = -180.0, 175.0  # westernmost / easternmost column (360 span, no antimeridian dupe)
    ...
    async def refresh(self):
        ...
        async with httpx.AsyncClient(timeout=30) as client:
            for start in range(0, len(lats), MAX_LOCATIONS_PER_CALL):
                ...
                chunk_lons = lons[start:start + MAX_LOCATIONS_PER_CALL]
                params = {
